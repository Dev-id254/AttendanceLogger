...
Microcontroller technology will be incooperated to capture this data using scanners and other relevant sensors. The data will then be processed in the backend and be displayed in a fine dashboard UI for the end user to visualize the results.
